...
public class Student {
	...
	public static void main(String[] args) {
		...
		System.out.println("Vnesete go maksimalniot broj na
		bodovi na testot");
		max=tastatura.nextDouble();
		System.out.println("Vnesete go brojot na bodovi koi gi
		dobil studentot");
		bodovi=tastatura.nextDouble();
		procent=bodovi/max*100;

		if (bodovi>max) {
		System.out.println("Studentot gi nadminal
		standardite, no za zal tolko poeni ne moze da dobie");
		System.exit(0);
		}
		procent=bodovi/max*100;
		if(procent<51 ) {
